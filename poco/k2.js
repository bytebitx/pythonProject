...
function r(n, t) {
    ...
    function call_js(start, len, time) {
        params = "poco_{\"start\":" + start +",\"length\":" + len + ",\"works_category\":\"1\",\"time_point\":" + time + "}_app"
        response_data = p(params, undefined, undefined)
        // console.log(response_data)
        return response_data.substring(5, 24)
    }

console.log(call_js(0, 20, 1680329454))
